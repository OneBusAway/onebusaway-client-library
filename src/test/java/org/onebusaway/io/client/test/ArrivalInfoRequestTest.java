...
public class ArrivalInfoRequestTest extends ObaTestCase {
    ...
    public void testTotalStopsInTrip() throws Exception {
         ...
         */
        ObaArrivalInfoResponse response =
                new ObaArrivalInfoRequest.Builder("Hillsborough%20Area%20Regional%20Transit_10000").build().call();
        assertOK(response);
         ...
         */
        response = new ObaArrivalInfoRequest.Builder("Hillsborough%20Area%20Regional%20Transit_6497").build().call();
        assertOK(response);
